...
func (t *SymDense) At(i, j int) float64 { _ = "STUB: not implemented"; return 0 }

func (t *SymDense) at(i, j int) float64 { _ = "STUB: not implemented"; return 0 }

func (t *SymDense) SetSym(i, j int, v float64) { _ = "STUB: not implemented"; return }

func (t *SymDense) set(i, j int, v float64) { _ = "STUB: not implemented"; return }
