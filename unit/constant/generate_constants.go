...
func (c Constant) IsDefined() bool { _ = "STUB: not implemented"; return false }

func (c Constant) Type() string { _ = "STUB: not implemented"; return "" }

func (c Constant) Units() string { _ = "STUB: not implemented"; return "" }

func (c Constant) dimensions() unit.Dimensions {
	_ = "STUB: not implemented"
	return *new(unit.Dimensions)
}
...
func generate(c Constant) { _ = "STUB: not implemented"; return }
...
func generateTest(c Constant) { _ = "STUB: not implemented"; return }
