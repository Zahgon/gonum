...
func (u Unit) Units() string { _ = "STUB: not implemented"; return "" }
...
func generate(unit Unit) { _ = "STUB: not implemented"; return }
...
func generateTest(unit Unit) { _ = "STUB: not implemented"; return }
