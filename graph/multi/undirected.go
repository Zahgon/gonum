...
func (g *UndirectedGraph) RemoveLine(fid, tid, id int64) { _ = "STUB: not implemented"; return }

func (g *UndirectedGraph) RemoveNode(id int64) { _ = "STUB: not implemented"; return }

func (g *UndirectedGraph) SetLine(l graph.Line) { _ = "STUB: not implemented"; return }
