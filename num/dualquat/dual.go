...
func ConjDual(d Number) Number { _ = "STUB: not implemented"; return *new(Number) }

func ConjQuat(d Number) Number { _ = "STUB: not implemented"; return *new(Number) }

func Scale(f float64, d Number) Number { _ = "STUB: not implemented"; return *new(Number) }

func Abs(d Number) dual.Number { _ = "STUB: not implemented"; return *new(dual.Number) }
