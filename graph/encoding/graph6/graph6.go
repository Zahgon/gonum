...
func (i *g6Iterator) Next() bool { _ = "STUB: not implemented"; return false }

func (i *g6Iterator) Len() int { _ = "STUB: not implemented"; return 0 }

func (i *g6Iterator) Reset() { _ = "STUB: not implemented"; return }

func (i *g6Iterator) Node() graph.Node { _ = "STUB: not implemented"; return *new(graph.Node) }

func numberOf(g Graph) int64 { _ = "STUB: not implemented"; return 0 }

func bitFor(xid, yid int64) int { _ = "STUB: not implemented"; return 0 }
