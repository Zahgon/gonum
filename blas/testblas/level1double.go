...
func DdotTest(t *testing.T, d Ddotter) { _ = "STUB: not implemented"; return }

type Dnrm2er interface {
	Dnrm2(n int, x []float64, incX int) float64
}

func Dnrm2Test(t *testing.T, blasser Dnrm2er) { _ = "STUB: not implemented"; return }

type Dasumer interface {
	Dasum(n int, x []float64, incX int) float64
}

func DasumTest(t *testing.T, blasser Dasumer) { _ = "STUB: not implemented"; return }

type Idamaxer interface {
	Idamax(n int, x []float64, incX int) int
}

func IdamaxTest(t *testing.T, blasser Idamaxer) { _ = "STUB: not implemented"; return }

type Dswapper interface {
	Dswap(n int, x []float64, incX int, y []float64, incY int)
}

func DswapTest(t *testing.T, d Dswapper) { _ = "STUB: not implemented"; return }

type Dcopier interface {
	Dcopy(n int, x []float64, incX int, y []float64, incY int)
}

func DcopyTest(t *testing.T, d Dcopier) { _ = "STUB: not implemented"; return }

type Daxpyer interface {
	Daxpy(n int, alpha float64, x []float64, incX int, y []float64, incY int)
}

func DaxpyTest(t *testing.T, d Daxpyer) { _ = "STUB: not implemented"; return }
...
func DrotgTest(t *testing.T, d Drotger, skipExtreme bool) { _ = "STUB: not implemented"; return }
...
func DrotmgTest(t *testing.T, d Drotmger) { _ = "STUB: not implemented"; return }

type Droter interface {
	Drot(n int, x []float64, incX int, y []float64, incY int, c, s float64)
}

func DrotTest(t *testing.T, d Droter) { _ = "STUB: not implemented"; return }

type Drotmer interface {
	Drotm(n int, x []float64, incX int, y []float64, incY int, p blas.DrotmParams)
}

func DrotmTest(t *testing.T, d Drotmer) { _ = "STUB: not implemented"; return }

type Dscaler interface {
	Dscal(n int, alpha float64, x []float64, incX int)
}

func DscalTest(t *testing.T, blasser Dscaler) { _ = "STUB: not implemented"; return }
